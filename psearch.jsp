...
<body>
	<h1 align="center"><b>Enter Patient ID to Search Data</b></h1>
	<form name="form"  >
			...
			<table width="100%">
               ...
               <tr>
                ...
                <tr>
					...
					<td >
						<input type="submit" class="button" value="Main Page" name="delete" onclick="window.location.href='mainpatient.html'" >
					</td>
					<td >
						<input type="submit" class="button" value="Print" name="print" onclick="f()" >
					</td>
			...
			<%
			    ...
			    try {
			        ...
			        if (rs.next()) 
			        {
			            ...
			            out.print("<tr><td>" + "Hospital ID" + "</td>");

			            out.print("<td>" + rs.getInt(8) + "</td></tr></h4>");
			            
			            out.print("<tr><td>" + "Vaccine ID" + "</td>");

			            out.print("<td>" + rs.getInt(9) + "</td></tr></h4>");
