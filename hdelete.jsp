...
<body>
	<h1 align="center"><b>Hospital Details</b></h1>
	<form name="form" >
		<div id="personal-details">
		
		<h2>Enter Hospital ID to Delete Data</h2>
			<table width="100%">
               <br>
               <br>
               <tr>
			...
			<%
					...
					try{
				        ...
				        PreparedStatement st = con.prepareStatement("delete from hospital where hid=?");
