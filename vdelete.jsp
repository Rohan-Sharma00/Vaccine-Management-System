...
<body>
	<h1 align="center"><b>Vacccine Details</b></h1>
	<form name="form" >
		<div id="personal-details">
		
		<h2>Enter Vaccine ID to Delete Data</h2>
			<table width="100%">
               <br>
               <br>
               <tr>
			...
			<%
					...
					try{
				        ...
				        PreparedStatement st = con.prepareStatement("delete from vaccine1 where vid=?");
